...
GENERATED_DIR  =  "../../../../../data/poetryFoundation/GENERATED/ELO_2015/AlchemyPatternHatcher_"+datetime.datetime.now().strftime('%Y-%m-%d_%H')+"/"
